...
const Women = ({ eliminarProducto, productosGlobal, vaciarCarrito, agregarCarrito}) => {
 ...
 const obtenerDatos = async () => {
    ...
    const data = await fetch("https://happyhour987.com/backendWoocomerceStudio/index.php/auth/getCategoriasWoman", requestOptions)
    ...
    const data2 = await fetch("https://happyhour987.com/wordpress/wp-json/wc/v3/products?category=31&per_page=99", requestOptions)
              ...
              <Grid item xs={12} md={3}>
                ...
                <div>
                  ...
                  <ContainerCheckBox>
                      ...
                      <FormControl sx={{ m: 1, width: "100%" }}>
                        <InputLabel id="demo-simple-select-label">Hoodies</InputLabel>
                        <Select
                          labelId="demo-simple-select-label"
                          id="demo-simple-select"
                          value={category2}
                      ...
                      <FormControl sx={{ m: 1, width: "100%" }}>
                        <InputLabel id="demo-simple-select-label">Sweatshirts</InputLabel>
                        <Select
                          labelId="demo-simple-select-label"
                          id="demo-simple-select"
                          value={category3}
