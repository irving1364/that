...
const Baby = ({ eliminarProducto, productosGlobal, vaciarCarrito, agregarCarrito}) => {
 ...
 const obtenerDatos = async () => {
    ...
    const data = await fetch("https://happyhour987.com/backendWoocomerceStudio/index.php/auth/getCategoriasKids", requestOptions)
    ...
    const data2 = await fetch("https://happyhour987.com/wordpress/wp-json/wc/v3/products?category=40&per_page=99", requestOptions)
